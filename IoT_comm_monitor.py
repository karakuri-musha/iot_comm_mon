...
def read_parameters(p_input_file_name):
    ...
    return r_defaunlt_route_addr,r_ping_retry_save_cnt,r_ping_retry_max_cnt,r_auto_recovery, r_comm_retry_intarval, r_comm_retry_cnt,r_comm_recovery_err_cmd, r_passphrase
...
if __name__=="__main__":
    ...
    # jsonファイル内の設定情報読み込み
    p_defroute,d_ping_retry_save_cnt,d_ping_retry_max_cnt,d_auto_recovery,d_comm_retry_intarval,d_comm_retry_cnt,d_comm_recovery_err_cmd, d_passphrase_enc = read_parameters(input_file_name)
